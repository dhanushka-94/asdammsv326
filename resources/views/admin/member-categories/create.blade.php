...
<div class="mx-auto max-w-xl">
    <form method="POST" action="{{ route('admin.member-categories.store') }}" class="card p-5 sm:p-8">
        @csrf
        @if ($errors->any())
        ...
        <div>
            ...
            <input id="name" type="text" name="name" value="{{ old('name') }}" required class="form-input" placeholder="e.g. Permanent, Temporary, Guest">
        </div>
